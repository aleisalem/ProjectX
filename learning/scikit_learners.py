...
from ProjectX.learning.string_kernel import *
...
def predictKFoldEnsemble(X, y, classifiers=[], kfold=10, selectKBest=0):
    """
    Classifies the data using an Ensemble classifier and k-fold CV
    :param X: The list of feature vectors
    :type X: list
    :param y: The labels corresponding to the feature vectors in X
    :type y: list
    :param classifiers: The list of classifiers in the ensemble (default: [])
